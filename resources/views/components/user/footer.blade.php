            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <a class="navbar-brand" href="#">
                        <img src="{{URL::asset('images/lafac-store-logo.png')}}" class="logo-image img-fluid" alt="templatemo pod talk">
                    </a>
                </div>
                ...
                <br>
                    <p class="copyright-text mb-0">Copyright © 2023 Salah Store Company</p>
                     {{--   <br><br>
